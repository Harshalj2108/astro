...
def calculate_saturn_sidereal_longitude(date, ephe_path='ephe'):
    """
    Calculate the sidereal longitude of the saturn for a given date
    ...
    -------
    float
        saturn's sidereal longitude in degrees.
    """
    # Set ephemeris path
    ...
    try:
        ...
        saturn_sidereal_long = pos[0]  # Sidereal longitude in degrees
    except Exception as e:
        raise RuntimeError(f"Error calculating saturn's position: {e}")

    return saturn_sidereal_long
