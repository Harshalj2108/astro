...
def calculate_sun_sidereal_longitude(date, ephe_path='ephe'):
    """
    Calculate the sidereal longitude of the Sun for a given date
    ...
    try:
        ...
        sun_sidereal_long = pos[0]  # Sidereal longitude in degrees
    except Exception as e:
        raise RuntimeError(f"Error calculating Sun's position: {e}")

    return sun_sidereal_long
