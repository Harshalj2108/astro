    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 p-8">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-gray-200">
        <svg viewBox="0 0 400 400" className="w-[600px] h-[600px]">
          ...
          {/* Lines from center to corners creating the diamond divisions */}
          <line x1="200" y1="10" x2="390" y2="200" stroke="black" strokeWidth="2.5" />
          <line x1="200" y1="10" x2="10" y2="200" stroke="black" strokeWidth="2.5" />
          <line x1="10" y1="200" x2="200" y2="390" stroke="black" strokeWidth="2.5" />
          <line x1="200" y1="390" x2="390" y2="200" stroke="black" strokeWidth="2.5" />
